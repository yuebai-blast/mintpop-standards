...
├── global/                        # 品牌总规范（跨产品共享）
│   ├── index.md  account-integration.md  payment-integration.md  brand.md  design-baseline.md
...
- **新增产品**：改 `products.ts` 一处 + 建 `products/<slug>/`（index.md + design.md）+ 放素材到 `public/assets/products/<slug>/`。
